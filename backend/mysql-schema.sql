...
INSERT INTO cms_content (content_key, label, value, type) VALUES
  ...
  ('home.locations.body', 'Home locations body', 'Yashobhoomi is the official HOI showcase venue for exhibitions and convention-led services.', 'text'),
  ...
  ('home.locations.cardDescription', 'Home locations card description', 'HOI Business Center''s primary exhibition venue.', 'text'),
  ...
  ('services.page.description', 'Services page description', 'Explore the six canonical HOI services. Each card opens a dedicated description page, and every service can flow into the booking path.', 'text'),
