  ...
  return (
    <div className="flex min-h-[70vh] items-center justify-center bg-gray-50 px-4">
      <div className="max-w-xl text-center">
        ...
        <h1 className="mb-4 text-7xl font-bold text-[#f97316]">404</h1>
        ...
        <Link
          href="/"
          className="inline-block rounded-xl bg-[#f97316] px-6 py-3 font-semibold text-white transition-colors hover:bg-[#ea580c]"
        >
          Return to Home
        </Link>
